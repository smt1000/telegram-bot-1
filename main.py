...
def send_question_18(chat_id):
    ...
    bot.send_message(
        chat_id,
        "Charlotte is following Danial after class. "
...
def send_question_23(chat_id):
    ...
    bot.send_message(
        chat_id,
        "“Danial walks into the school and listens to Grace’s story, which receives criticism."
    )
...
def question_23_answer(call):
    ...
    bot.send_message(
		...
		"Danial sets in a nearby chair and they started talking"
...
def question_24_answer(call):
    ...
    bot.send_message(
        ...
        "Danial :I remembered something important "
    )
...
def question_27_answer(call):
    ...
    bot.send_message(
        call.message.chat.id,
        "Danial: Today, I decided to go to the library.  \n\n"
...
def send_question_29(chat_id):
    ...
    IMAGE_URL3 = "https://i.ibb.co/0pyy5z4V/Charlotte-2.jpg"
    # --------------------------------------------------------
    # QUESTION 29 IMAGE
    # --------------------------------------------------------
...
def send_question_30(chat_id):
    ...
    IMAGE_URL3 = "https://i.ibb.co/361jJv2/General-1.jpg"
    # --------------------------------------------------------
    # QUESTION 30 IMAGE
    # --------------------------------------------------------
